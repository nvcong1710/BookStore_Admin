      ...
      <div className="m-8">
        ...
        <div className="grid grid-cols-3">
          <div className="col-span-3 xl:col-span-2">
            <div className="py-5 pr-6">
              <div>
                ...
                <input
                  className="px-3 py-2 border rounded-md shadow-sm mt-1 block w-full sm:text-base"
                  type="text"
                  id="name"
              ...
              <div>
                ...
                <textarea
                  className="px-3 py-2 border rounded-md shadow-sm mt-1 block w-full h-32 sm:text-base"
                  id="description"
              ...
              <div className="px-4 py-3 rounded-b-md sm:px-6">
          ...
          <div className="col-span-3 xl:col-span-1 space-y-6">
            <div className="bg-white shadow-sm ring-1 rounded-md sm:rounded-lg">
              ...
              <div className="px-4 py-5 sm:px-6 -mt-5">
                <select className="block px-3 py-2 w-full ring-1 rounded-md border-slate-300 shadow-sm sm:text-base"
